...
<body>
    <div id="warp"><!-- 전체범위 레이아웃 wrap 시작 -->
        ...
        <aside>
            <article id="login_box">
                <div id="input_button">
                    ...
                    <!-- <img id="login_button" src="img/btn_login.gif"> -->
                </div>
                <div class="clear"></div>
                <div id="join_search">
        ...
        <main>
            ...
            <section id="notice_free_youtube">
                ...
                <article id="free"><!-- 자유게시판 시작 -->
                    ...
                    <div class="latest_content">
                        ...
                        <ul class="list">
                            <li>
                                <div class="subject"><a href="board_list.html">까스통님의 선물인 보드카...</a></div>
                                <div class="date">2017-09-20</div>
                                <div class="clear"></div>
                            </li>
                            <li>
            ...
            <section id="gallery"><!-- gallery 시작 -->
                <img src="img/latest4.gif">
                <div id="gallery_box"><!-- gallery box시작 -->
                    <div id="gallery_list">
                        <div class="items">
                            <ul>
        ...
        <footer><!-- footer 시작 -->
            ...
            <ul id="address">
                ...
                <li>COPYTRIGHTⓒ 루바토 ALL RIGHT RESERVED</li>
            </ul>
            <ul id="footer_sns">
